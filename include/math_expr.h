...
// sqrt, tan, tanh). Returns NAN on parse/evaluation error. If error
// is non-NULL, receives 0 on success or the 1-based position of the
...
// Prevents callers without their own length cap from feeding
// arbitrarily large input.
#define MATH_INPUT_MAX  4096

// Limits stack growth from deeply nested parentheses, chained function
// calls (e.g. sin sin sin ... 1), or exponent chains (e.g. 2^2^2^...^2).
