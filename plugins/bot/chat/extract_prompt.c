...
static const char *extract_prompt_tail =
    ...
    "- NEVER emit the name of a bot taking part in the transcript. A "
    "name that many different speakers address (\"<name>: ...\") is who "
    "they are talking TO, not a nickname for any of them.\n"
