# MEMSTORE.md — Memory Subsystem (`plugins/method/text/memory.c`)
...
> **Sibling subsystem**: `plugins/extension/inference/engine/knowledge.c` stores
...
> **acquisition engine** (`plugins/extension/inference/engine/acquire.c`, see
...
`plugins/method/text/memory.c` provides a bot-agnostic store for two kinds of persistent
state:
