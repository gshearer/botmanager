...
The subsystem lives in `plugins/method/text/extract.c` /
`plugins/method/text/extract_prompt.c` and is fronted by
`plugins/method/text/extract.h`. Per-bot knobs live on the chatbot
plugin (`plugins/method/text/chatbot.c`).
