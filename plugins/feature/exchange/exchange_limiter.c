...
//
// Bucket math is adapted from whenmoon's dl_scheduler.c — the legacy
// per-bot limiter retired in EX-1 (aaea176). No path is given because
// the file no longer exists. The reserved-slot
